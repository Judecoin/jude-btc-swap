...
We are working on implementing a protocol where JUDE moves first, but are currently blocked by advances on Jude itself.
...
```shell
./swap --testnet buy-jude --receive-address <YOUR JUDE ADDRESS> --change-address <YOUR BITCOIN CHANGE ADDRESS> --seller <SELLER MULTIADDRESS>
```
...
Feel free to reach out to us in the judeDevelop@gmail.com
