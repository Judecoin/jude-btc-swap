...
// Linux: /home/<user>/.config/jude-btc-swap/
// OSX: /Users/<user>/Library/Preferences/jude-btc-swap/
fn default_config_dir() -> Option<PathBuf> {
    ProjectDirs::from("", "", "jude-btc-swap").map(|proj_dirs| proj_dirs.config_dir().to_path_buf())
}
...
// Linux: /home/<user>/.local/share/jude-btc-swap/
// OSX: /Users/<user>/Library/Application Support/jude-btc-swap/
pub fn default_data_dir() -> Option<std::path::PathBuf> {
    ProjectDirs::from("", "", "jude-btc-swap").map(|proj_dirs| proj_dirs.data_dir().to_path_buf())
}
