    ...
    protocol::{
        ...
        alice::{
            ...
            steps::{
                ...
                extract_jude_private_key, lock_jude, publish_bitcoin_punish_transaction,
    ...
    if is_target_state(&state) {
        ...
        match state {
            ...
            AliceState::BtcLocked {
                ...
                let state = AliceState::judeLocked {
                    state3,
            ...
            AliceState::BtcCancelled {
                ...
                match published_refund_tx {
                    ...
                    Some(published_refund_tx) => {
                        let spend_key = extract_jude_private_key(
                            published_refund_tx,
                            &tx_refund,
                            state3.s_a,
                            state3.a.clone(),
            ...
            AliceState::BtcRefunded {
                ...
                let state = AliceState::judeRefunded;
                let db_state = (&state).into();
                db.insert_latest_state(swap_id, database::Swap::Alice(db_state))
                    .await?;
                Ok(state)
            ...
            AliceState::judeRefunded => Ok(AliceState::judeRefunded),
