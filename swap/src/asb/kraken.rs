...
const SUBSCRIBE_jude_BTC_TICKER_PAYLOAD: &str = r#"
{ "event": "subscribe",
  "pair": [ "jude/XBT" ],
  "subscription": {
    "name": "ticker"
...
impl RateService {
    pub async fn new() -> Result<Self> {
        ...
        rate_stream_sink
            .send(SUBSCRIBE_jude_BTC_TICKER_PAYLOAD.into())
            .await?;
...
mod tests {
    ...
    async fn deserialize_ticker_update() {
        let sample_response = r#"[980,{"a":["0.00521900",4,"4.84775132"],"b":["0.00520600",70,"70.35668921"],"c":["0.00520700","0.00000186"],"v":["18530.40510860","18531.94887860"],"p":["0.00489493","0.00489490"],"t":[5017,5018],"l":["0.00448300","0.00448300"],"h":["0.00525000","0.00525000"],"o":["0.00450000","0.00451000"]},"ticker","jude/XBT"]"#;
